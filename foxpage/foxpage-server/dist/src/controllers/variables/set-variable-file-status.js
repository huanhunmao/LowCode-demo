...
exports.SetVariableFileStatus = void 0;
...
let SetVariableFileStatus = class SetVariableFileStatus extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
    ...
    async index(ctx, params) {
        ...
        try {
            ...
            if (!hasAuth) {
                return Response.accessDeny(app_config_1.i18n.system.accessDeny, 4080801);
            }
            ...
            if (result.code === 1) {
                return Response.warning(app_config_1.i18n.file.invalidFileId, 2080801);
            }
            else if (result.code === 2) {
                return Response.warning(app_config_1.i18n.variable.fileCannotBeDeleted, 2080803);
            }
            ...
            return Response.error(err, app_config_1.i18n.variable.setVariableFileDeletedFailed, 3080801);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.setVariableFileStatus,
        description: '',
        tags: ['Variable'],
...
], SetVariableFileStatus.prototype, "index", null);
SetVariableFileStatus = __decorate([
    (0, routing_controllers_1.JsonController)('variables'),
    __metadata("design:paramtypes", [])
], SetVariableFileStatus);
exports.SetVariableFileStatus = SetVariableFileStatus;
