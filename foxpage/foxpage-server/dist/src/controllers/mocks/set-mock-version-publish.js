...
exports.SetMockPublishStatus = void 0;
...
let SetMockPublishStatus = class SetMockPublishStatus extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
    ...
    async index(ctx, params) {
        try {
            ...
            if (!hasAuth) {
                return Response.accessDeny(app_config_1.i18n.system.accessDeny, 4191001);
            }
            // Set publishing status
            const result = await this.service.version.live.setVersionPublishStatus(params, {
                ctx,
                liveRelation: true,
                actionType: [constant_1.LOG.PUBLISH, constant_1.TYPE.MOCK].join('_'),
            });
            if (result.code === 1) {
                return Response.warning(app_config_1.i18n.mock.mockVersionHasPublished, 2191001);
            }
            ...
            return Response.error(err, app_config_1.i18n.mock.setMockPublishStatusFailed, 3191001);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.setMockVersionPublishStatus,
        description: '',
        tags: ['Mock'],
...
], SetMockPublishStatus.prototype, "index", null);
SetMockPublishStatus = __decorate([
    (0, routing_controllers_1.JsonController)('mocks'),
    __metadata("design:paramtypes", [])
], SetMockPublishStatus);
exports.SetMockPublishStatus = SetMockPublishStatus;
