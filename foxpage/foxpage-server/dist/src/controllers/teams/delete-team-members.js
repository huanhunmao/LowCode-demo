...
exports.DeleteTeamMemberList = void 0;
...
let DeleteTeamMemberList = class DeleteTeamMemberList extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
    ...
    async index(ctx, params) {
        try {
            ...
            return Response.error(err, app_config_1.i18n.team.updateTeamMemberFailed, 3020301);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.deleteTeamMembers,
        description: '',
        tags: ['Team'],
...
], DeleteTeamMemberList.prototype, "index", null);
DeleteTeamMemberList = __decorate([
    (0, routing_controllers_1.JsonController)('teams'),
    __metadata("design:paramtypes", [])
], DeleteTeamMemberList);
exports.DeleteTeamMemberList = DeleteTeamMemberList;
