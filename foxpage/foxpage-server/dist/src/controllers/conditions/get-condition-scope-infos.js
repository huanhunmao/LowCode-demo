...
exports.GetAppConditionScopeInfoList = void 0;
...
let GetAppConditionScopeInfoList = class GetAppConditionScopeInfoList extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
    ...
    async index(params) {
        ...
        try {
            ...
            options.type = constant_1.TYPE.CONDITION;
            ...
            for (const version of allVersionList) {
                ...
                const itemRelations = await this.service.relation.formatRelationResponse(itemVersionRelations);
            ...
            return Response.error(err, app_config_1.i18n.condition.getAppScopeConditionFailed, 3100301);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.getScopeConditions,
        description: '',
        tags: ['Condition'],
    ...
    __metadata("design:paramtypes", [project_validate_types_1.ProjectScopeTypeReq]),
    __metadata("design:returntype", Promise)
], GetAppConditionScopeInfoList.prototype, "index", null);
GetAppConditionScopeInfoList = __decorate([
    (0, routing_controllers_1.JsonController)('conditions'),
    __metadata("design:paramtypes", [])
], GetAppConditionScopeInfoList);
exports.GetAppConditionScopeInfoList = GetAppConditionScopeInfoList;
