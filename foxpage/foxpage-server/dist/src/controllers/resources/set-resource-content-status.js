...
exports.SetResourceContentStatus = void 0;
...
let SetResourceContentStatus = class SetResourceContentStatus extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
    ...
    async index(ctx, params) {
        ...
        try {
            ...
            if (!hasAuth) {
                return Response.accessDeny(app_config_1.i18n.system.accessDeny, 4121501);
            }
            const result = await this.service.content.info.setContentDeleteStatus(params, { ctx });
            if (result.code === 1) {
                return Response.warning(app_config_1.i18n.resource.invalidResourceContentId, 2121501);
            }
            else if (result.code === 2) {
                return Response.warning(app_config_1.i18n.resource.contentCannotBeDeleted, 2121502);
            }
            ...
            return Response.error(err, app_config_1.i18n.resource.setResourceContentDeletedFailed, 3121501);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.setResourceContentStatus,
        description: '',
        tags: ['Resource'],
...
], SetResourceContentStatus.prototype, "index", null);
SetResourceContentStatus = __decorate([
    (0, routing_controllers_1.JsonController)('resources'),
    __metadata("design:paramtypes", [])
], SetResourceContentStatus);
exports.SetResourceContentStatus = SetResourceContentStatus;
