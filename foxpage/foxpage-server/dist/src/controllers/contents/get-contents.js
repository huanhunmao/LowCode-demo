...
let GetContentList = class GetContentList extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
    ...
    async index(params) {
        try {
            ...
            if (!fileDetail || fileDetail.deleted) {
                return Response.warning(app_config_1.i18n.file.invalidFileId, 2160301);
            }
            const contentList = await this.service.content.file.getFileContentList(params);
            return Response.success(contentList, 1160301);
        }
        catch (err) {
            return Response.error(err, app_config_1.i18n.content.getContentListFailed, 3160301);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.contentList,
        description: '',
        tags: ['Content'],
...
], GetContentList.prototype, "index", null);
GetContentList = __decorate([
