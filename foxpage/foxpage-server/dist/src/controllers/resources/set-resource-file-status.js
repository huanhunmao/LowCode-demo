...
exports.SetResourceFileStatus = void 0;
...
let SetResourceFileStatus = class SetResourceFileStatus extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
    ...
    async index(ctx, params) {
        ...
        try {
            ...
            if (!hasAuth) {
                return Response.accessDeny(app_config_1.i18n.system.accessDeny, 4121601);
            }
            const result = await this.service.file.info.setFileDeleteStatus(params, { ctx });
            if (result.code === 1) {
                return Response.warning(app_config_1.i18n.file.invalidFileId, 2121601);
            }
            else if (result.code === 2) {
                return Response.warning(app_config_1.i18n.resource.fileCannotBeDeleted, 2121602);
            }
            ...
            return Response.error(err, app_config_1.i18n.resource.setResourceFileDeletedFailed, 3121601);
        }
    }
};
__decorate([
    (0, routing_controllers_1.Put)('/file-status'),
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.setResourceFileStatus,
        description: '',
        tags: ['Resource'],
...
], SetResourceFileStatus.prototype, "index", null);
SetResourceFileStatus = __decorate([
    (0, routing_controllers_1.JsonController)('resources'),
    __metadata("design:paramtypes", [])
], SetResourceFileStatus);
exports.SetResourceFileStatus = SetResourceFileStatus;
