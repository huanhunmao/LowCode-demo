...
exports.AddTemplateContentDetail = void 0;
...
let AddTemplateContentDetail = class AddTemplateContentDetail extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
    ...
    async index(ctx, params) {
        try {
            ...
            ctx.logAttr = Object.assign(ctx.logAttr, { id: contentDetail.id, type: constant_1.TYPE.TEMPLATE });
            return Response.success(templateContentDetail, 1070101);
        }
        catch (err) {
            return Response.error(err, app_config_1.i18n.template.addNewTemplateContentFailed, 3070101);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.addTemplateContentDetail,
        description: '',
        tags: ['Template'],
...
], AddTemplateContentDetail.prototype, "index", null);
AddTemplateContentDetail = __decorate([
    (0, routing_controllers_1.JsonController)('templates'),
    __metadata("design:paramtypes", [])
], AddTemplateContentDetail);
exports.AddTemplateContentDetail = AddTemplateContentDetail;
