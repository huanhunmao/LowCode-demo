...
exports.GetVariableBuildDetail = void 0;
...
let GetVariableBuildDetail = class GetVariableBuildDetail extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
    ...
    async index(params) {
        ...
        try {
            ...
            return Response.error(err, app_config_1.i18n.variable.getAppVariableFailed, 3080401);
        }
    }
};
__decorate([
...
], GetVariableBuildDetail.prototype, "index", null);
GetVariableBuildDetail = __decorate([
    (0, routing_controllers_1.JsonController)('variables'),
    __metadata("design:paramtypes", [])
], GetVariableBuildDetail);
exports.GetVariableBuildDetail = GetVariableBuildDetail;
