...
exports.GetPageFunctionList = void 0;
...
let GetPageFunctionList = class GetPageFunctionList extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
        ...
        try {
            if (params.folderId) {
                ...
                if (!folderDetail || folderDetail.deleted || folderDetail.applicationId !== params.applicationId) {
                    return Response.warning(app_config_1.i18n.folder.invalidFolderId);
                }
            }
            else {
            ...
            const fileInfo = await this.service.file.list.getItemFileContentDetail(params, constant_1.TYPE.FUNCTION);
            ...
            return Response.error(err, app_config_1.i18n.function.getPageFunctionFailed, 3090601);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.getAppPageFunctions,
        description: '',
        tags: ['Function'],
...
], GetPageFunctionList.prototype, "index", null);
GetPageFunctionList = __decorate([
    (0, routing_controllers_1.JsonController)('function-searchs'),
    __metadata("design:paramtypes", [])
], GetPageFunctionList);
exports.GetPageFunctionList = GetPageFunctionList;
