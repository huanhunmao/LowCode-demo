...
export declare class PluginLoaderImpl implements PluginLoader {
     ...
     * @return {*}
     */
    getHooks(mode?: Mode): Partial<Record<"beforeNodeBuild" | "afterNodeBuild" | "beforePageBuild" | "afterPageBuild" | "beforeDSLFetch" | "afterDSLFetch" | "beforeNodeParse" | "afterNodeParse" | "beforeDSLParse" | "afterDSLParse" | "beforePageRender" | "onPageRender" | "afterPageRender" | "onRenderError" | "beforeIgnite" | "onInitLogger" | "afterIgnite" | "registerVariableParser" | "registerRouter" | "afterContextCreate", () => void>>;
    /**
     * destroy
     */
    destroy(): void;
