...
let GetPageMockList = class GetPageMockList extends base_controller_1.BaseController {
    ...
    async index(params) {
        try {
            const typePageParams = Object.assign({ type: constant_1.TYPE.MOCK, deleted: false }, params);
            ...
            if (result.list.length > 0) {
                fileList = await this.service.file.list.getFileAssocInfo(result.list, { type: constant_1.TYPE.MOCK });
            }
            ...
            return Response.error(err, app_config_1.i18n.mock.getAppPageMockFailed, 3190201);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.getAppScopeMocks,
        description: '',
        tags: ['Mock'],
