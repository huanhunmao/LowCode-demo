...
exports.SetPageVersionPublishAndLiveStatus = void 0;
...
let SetPageVersionPublishAndLiveStatus = class SetPageVersionPublishAndLiveStatus extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
    ...
    async index(ctx, params) {
        ...
        try {
            ...
            if (!hasAuth) {
                return Response.accessDeny(app_config_1.i18n.system.accessDeny, 4051301);
            }
            ...
            if (result.code === 1) {
                return Response.warning(app_config_1.i18n.page.pageVersionHasPublished, 2051301);
            }
            else if (result.code === 2) {
                return Response.warning(app_config_1.i18n.page.invalidRelations + ':' + Object.keys(result.data).join(','), 2051302);
            }
            ...
            return Response.error(err, app_config_1.i18n.page.setPagePublishStatusFailed, 3051301);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.setPageVersionPublishLiveStatus,
        description: '',
        tags: ['Page'],
...
], SetPageVersionPublishAndLiveStatus.prototype, "index", null);
SetPageVersionPublishAndLiveStatus = __decorate([
    (0, routing_controllers_1.JsonController)('pages'),
    __metadata("design:paramtypes", [])
], SetPageVersionPublishAndLiveStatus);
exports.SetPageVersionPublishAndLiveStatus = SetPageVersionPublishAndLiveStatus;
