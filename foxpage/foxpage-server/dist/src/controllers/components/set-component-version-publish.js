...
exports.SetComponentVersionPublishStatus = void 0;
...
let SetComponentVersionPublishStatus = class SetComponentVersionPublishStatus extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
    ...
    async index(ctx, params) {
        try {
            ...
            if (!hasAuth) {
                return Response.accessDeny(app_config_1.i18n.system.accessDeny, 4111601);
            }
            ...
            if (result.code === 1) {
                return Response.warning(app_config_1.i18n.component.componentVersionHasPublished, 2111601);
            }
            ...
            return Response.error(err, app_config_1.i18n.component.setComponentPublishStatusFailed, 3111601);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.setComponentVersionPublishStatus,
        description: '',
        tags: ['Component'],
...
], SetComponentVersionPublishStatus.prototype, "index", null);
SetComponentVersionPublishStatus = __decorate([
    (0, routing_controllers_1.JsonController)('components'),
    __metadata("design:paramtypes", [])
], SetComponentVersionPublishStatus);
exports.SetComponentVersionPublishStatus = SetComponentVersionPublishStatus;
