...
let GetComponentVersionDetail = class GetComponentVersionDetail extends base_controller_1.BaseController {
    ...
    async index(params) {
        try {
            ...
            if (!versionDetail) {
                return Response.warning(app_config_1.i18n.component.invalidVersionId, 2110601);
            }
            ...
            return Response.error(err, app_config_1.i18n.content.getComponentVersionDetailFailed, 3110601);
        }
    }
};
__decorate([
    (0, routing_controllers_1.Get)('/edit-versions'),
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.getComponentEditVersionDetail,
        description: '',
        tags: ['Component'],
    ...
    __metadata("design:paramtypes", [component_validate_types_1.ComponentVersionEditReq]),
