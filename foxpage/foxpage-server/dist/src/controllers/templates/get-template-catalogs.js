    ...
    async index(params) {
        try {
            ...
            if (!fileDetail ||
                ...
                fileDetail.type !== constant_1.TYPE.TEMPLATE) {
                return Response.warning(app_config_1.i18n.file.invalidFileId, 2070701);
            }
            ...
            return Response.error(err, app_config_1.i18n.page.getPagePagesFailed, 3070701);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.getTemplateCatalogs,
        description: '',
        tags: ['Template'],
