...
exports.SetConditionVersionStatus = void 0;
...
let SetConditionVersionStatus = class SetConditionVersionStatus extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
    ...
    async index(ctx, params) {
        ...
        try {
            ...
            if (!hasAuth) {
                return Response.accessDeny(app_config_1.i18n.system.accessDeny, 4101101);
            }
            ...
            if (result.code === 1) {
                return Response.warning(app_config_1.i18n.condition.invalidVersionId, 2101101);
            }
            else if (result.code === 2) {
                return Response.warning(app_config_1.i18n.condition.versionCannotBeDeleted, 2101102);
            }
            ...
            return Response.error(err, app_config_1.i18n.condition.setConditionStatusFailed, 3101101);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.setConditionVersionStatus,
        description: '',
        tags: ['Condition'],
...
], SetConditionVersionStatus.prototype, "index", null);
SetConditionVersionStatus = __decorate([
    (0, routing_controllers_1.JsonController)('conditions'),
    __metadata("design:paramtypes", [])
], SetConditionVersionStatus);
exports.SetConditionVersionStatus = SetConditionVersionStatus;
