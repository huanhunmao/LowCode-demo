        ...
        try {
            ...
            if (params.folderId) {
                ...
                if (!folderDetail || folderDetail.deleted || folderDetail.applicationId !== params.applicationId) {
                    return Response.warning(app_config_1.i18n.folder.invalidFolderId, 2080301);
                }
            }
            else {
            ...
            const fileInfo = await this.service.file.list.getItemFileContentDetail(params, constant_1.TYPE.VARIABLE);
            ...
            return Response.error(err, app_config_1.i18n.variable.getPageVariableFailed, 3080301);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.getAppPageVariables,
        description: '',
        tags: ['Variable'],
...
GetPageVariableList = __decorate([
    (0, routing_controllers_1.JsonController)('variable-searchs'),
