...
exports.GetConditionBuildDetail = void 0;
...
let GetConditionBuildDetail = class GetConditionBuildDetail extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
    ...
    async index(params) {
        ...
        try {
            ...
            return Response.error(err, app_config_1.i18n.condition.getAppConditionFailed, 3101701);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.getConditionBuildDetail,
        description: '',
        tags: ['Condition'],
...
], GetConditionBuildDetail.prototype, "index", null);
GetConditionBuildDetail = __decorate([
    (0, routing_controllers_1.JsonController)('conditions'),
    __metadata("design:paramtypes", [])
], GetConditionBuildDetail);
exports.GetConditionBuildDetail = GetConditionBuildDetail;
