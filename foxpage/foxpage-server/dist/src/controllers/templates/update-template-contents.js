...
exports.UpdateTemplateContentDetail = void 0;
...
let UpdateTemplateContentDetail = class UpdateTemplateContentDetail extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
    ...
    async index(ctx, params) {
        try {
            ...
            if (!hasAuth) {
                return Response.accessDeny(app_config_1.i18n.system.accessDeny, 4071601);
            }
            ...
            const result = await this.service.content.info.updateContentDetail(Object.assign({}, params, { type: constant_1.TYPE.TEMPLATE }), { ctx, actionType: [constant_1.LOG.UPDATE, constant_1.TYPE.TEMPLATE].join('_') });
            if (result.code === 1) {
                return Response.warning(app_config_1.i18n.template.invalidTemplateContentId, 2071601);
            }
            else if (result.code === 2) {
                return Response.warning(app_config_1.i18n.template.invalidIdType, 2071602);
            }
            else if (result.code === 3) {
                return Response.warning(app_config_1.i18n.template.templateNameExist, 2071603);
            }
            ...
            return Response.error(err, app_config_1.i18n.template.updateTemplateContentFailed, 3071601);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.updateTemplateContentDetail,
...
], UpdateTemplateContentDetail.prototype, "index", null);
UpdateTemplateContentDetail = __decorate([
    (0, routing_controllers_1.JsonController)('templates'),
    __metadata("design:paramtypes", [])
], UpdateTemplateContentDetail);
exports.UpdateTemplateContentDetail = UpdateTemplateContentDetail;
