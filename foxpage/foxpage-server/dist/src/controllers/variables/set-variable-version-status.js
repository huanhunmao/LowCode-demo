...
exports.SetVariableVersionStatus = void 0;
...
let SetVariableVersionStatus = class SetVariableVersionStatus extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
    ...
    async index(ctx, params) {
        ...
        try {
            ...
            if (!hasAuth) {
                return Response.accessDeny(app_config_1.i18n.system.accessDeny, 4081101);
            }
            ...
            if (result.code === 1) {
                return Response.warning(app_config_1.i18n.variable.invalidVersionId, 2081101);
            }
            else if (result.code === 2) {
                return Response.warning(app_config_1.i18n.variable.versionCannotBeDeleted, 2081102);
            }
            ...
            return Response.error(err, app_config_1.i18n.variable.setVariableVersionDeletedFailed, 3081101);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.setVariableVersionStatus,
        description: '',
        tags: ['Variable'],
...
], SetVariableVersionStatus.prototype, "index", null);
SetVariableVersionStatus = __decorate([
    (0, routing_controllers_1.JsonController)('variables'),
    __metadata("design:paramtypes", [])
], SetVariableVersionStatus);
exports.SetVariableVersionStatus = SetVariableVersionStatus;
