...
exports.SetTemplateFileStatus = void 0;
...
let SetTemplateFileStatus = class SetTemplateFileStatus extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
    ...
    async index(ctx, params) {
        ...
        try {
            ...
            if (!hasAuth) {
                return Response.accessDeny(app_config_1.i18n.system.accessDeny, 4071101);
            }
            ...
            if (result.code === 1) {
                return Response.warning(app_config_1.i18n.file.invalidFileId, 2071101);
            }
            else if (result.code === 2) {
                return Response.warning(app_config_1.i18n.template.fileCannotBeDeleted, 2071102);
            }
            ...
            return Response.error(err, app_config_1.i18n.template.setTemplateFileDeletedFailed, 3071101);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.setTemplateFileStatus,
        description: '',
        tags: ['Template'],
...
], SetTemplateFileStatus.prototype, "index", null);
SetTemplateFileStatus = __decorate([
    (0, routing_controllers_1.JsonController)('templates'),
    __metadata("design:paramtypes", [])
], SetTemplateFileStatus);
exports.SetTemplateFileStatus = SetTemplateFileStatus;
