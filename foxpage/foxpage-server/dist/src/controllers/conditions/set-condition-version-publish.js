...
exports.SetConditionVersionPublishStatus = void 0;
...
let SetConditionVersionPublishStatus = class SetConditionVersionPublishStatus extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
    ...
    async index(ctx, params) {
        try {
            ...
            if (!params.id && !params.contentId) {
                return Response.warning(app_config_1.i18n.condition.invalidConditionId, 2101001);
            }
            // Permission check
            const hasAuth = await this.service.auth.version(params.id, { ctx });
            if (!hasAuth) {
                return Response.accessDeny(app_config_1.i18n.system.accessDeny, 4101001);
            }
            if (!params.id) {
            ...
            if (!params.id) {
                return Response.warning(app_config_1.i18n.condition.invalidConditionId, 2101002);
            }
            // Set publishing status
            const result = await this.service.version.live.setVersionPublishStatus(params, {
                ctx,
                liveRelation: true,
                actionType: [constant_1.LOG.PUBLISH, constant_1.TYPE.CONDITION].join('_'),
            });
            if (result.code === 1) {
                return Response.warning(app_config_1.i18n.condition.conditionVersionHasPublished, 2101003);
            }
            ...
            return Response.error(err, app_config_1.i18n.condition.setConditionPublishStatusFailed, 3101001);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.setConditionVersionPublishStatus,
        description: '',
        tags: ['Condition'],
...
], SetConditionVersionPublishStatus.prototype, "index", null);
SetConditionVersionPublishStatus = __decorate([
    (0, routing_controllers_1.JsonController)('conditions'),
    __metadata("design:paramtypes", [])
], SetConditionVersionPublishStatus);
exports.SetConditionVersionPublishStatus = SetConditionVersionPublishStatus;
