...
exports.GetAppScopeMockList = void 0;
...
let GetAppScopeMockList = class GetAppScopeMockList extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
    ...
    async index(ctx, params) {
        ...
        try {
            ...
            options.type = constant_1.TYPE.MOCK;
            ...
            return Response.error(err, app_config_1.i18n.mock.getAppMockFailed, 3190501);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.getScopeMocks,
        description: '',
        tags: ['Mock'],
...
], GetAppScopeMockList.prototype, "index", null);
GetAppScopeMockList = __decorate([
    (0, routing_controllers_1.JsonController)('mocks'),
    __metadata("design:paramtypes", [])
], GetAppScopeMockList);
exports.GetAppScopeMockList = GetAppScopeMockList;
