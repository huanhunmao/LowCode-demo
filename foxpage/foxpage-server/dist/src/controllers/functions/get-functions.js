...
exports.GetAppFunctionList = void 0;
...
let GetAppFunctionList = class GetAppFunctionList extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
    ...
    async index(ctx, params) {
        try {
            ...
            return Response.success(pageVersions, 1090501);
        }
        catch (err) {
            return Response.error(err, app_config_1.i18n.function.getAppFunctionLiveFailed, 3090501);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.getAppFunctionLiveDetail,
        description: '',
        tags: ['Function'],
...
], GetAppFunctionList.prototype, "index", null);
GetAppFunctionList = __decorate([
    (0, routing_controllers_1.JsonController)('functions'),
    __metadata("design:paramtypes", [])
], GetAppFunctionList);
exports.GetAppFunctionList = GetAppFunctionList;
