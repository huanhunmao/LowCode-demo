...
exports.SetVersionPublishStatus = void 0;
...
let SetVersionPublishStatus = class SetVersionPublishStatus extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
    ...
    async index(ctx, params) {
        try {
            ...
            if (!params.id && !params.contentId) {
                return Response.warning(app_config_1.i18n.variable.invalidVariableId, 2081002);
            }
            const hasAuth = await this.service.auth.version(params.id, { ctx });
            if (!hasAuth) {
                return Response.accessDeny(app_config_1.i18n.system.accessDeny, 4081001);
            }
            if (!params.id) {
            ...
            if (!params.id) {
                return Response.warning(app_config_1.i18n.variable.invalidVariableId, 2081003);
            }
            // Set publishing status
            const result = await this.service.version.live.setVersionPublishStatus(params, {
                ctx,
                liveRelation: true,
                actionType: [constant_1.LOG.PUBLISH, constant_1.TYPE.VARIABLE].join('_'),
            });
            if (result.code === 1) {
                return Response.warning(app_config_1.i18n.variable.variableVersionHasPublished, 2081001);
            }
            ...
            return Response.error(err, app_config_1.i18n.variable.setVariablePublishStatusFailed, 3081001);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.setVariableVersionPublishStatus,
        description: '',
        tags: ['Variable'],
...
], SetVersionPublishStatus.prototype, "index", null);
SetVersionPublishStatus = __decorate([
    (0, routing_controllers_1.JsonController)('variables'),
    __metadata("design:paramtypes", [])
], SetVersionPublishStatus);
exports.SetVersionPublishStatus = SetVersionPublishStatus;
