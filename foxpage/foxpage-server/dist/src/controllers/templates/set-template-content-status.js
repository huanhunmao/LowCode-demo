...
exports.SetTemplateContentStatus = void 0;
...
let SetTemplateContentStatus = class SetTemplateContentStatus extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
    ...
    async index(ctx, params) {
        ...
        try {
            ...
            if (!hasAuth) {
                return Response.accessDeny(app_config_1.i18n.system.accessDeny, 4071001);
            }
            ...
            if (result.code === 1) {
                return Response.warning(app_config_1.i18n.content.invalidContentId, 2071001);
            }
            else if (result.code === 2) {
                return Response.warning(app_config_1.i18n.template.contentCannotBeDeleted, 2071002);
            }
            ...
            return Response.error(err, app_config_1.i18n.template.setTemplateContentDeletedFailed, 3071001);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.setTemplateContentStatus,
        description: '',
        tags: ['Template'],
...
], SetTemplateContentStatus.prototype, "index", null);
SetTemplateContentStatus = __decorate([
    (0, routing_controllers_1.JsonController)('templates'),
    __metadata("design:paramtypes", [])
], SetTemplateContentStatus);
exports.SetTemplateContentStatus = SetTemplateContentStatus;
