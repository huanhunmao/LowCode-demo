...
exports.GetAppTemplateList = void 0;
...
let GetAppTemplateList = class GetAppTemplateList extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
    ...
    async index(ctx, params) {
        try {
            ...
            return Response.error(err, app_config_1.i18n.template.getAppTemplatesFailed, 3070901);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.getAppTemplates,
        description: '',
        tags: ['Template'],
...
], GetAppTemplateList.prototype, "index", null);
GetAppTemplateList = __decorate([
    (0, routing_controllers_1.JsonController)('templates'),
    __metadata("design:paramtypes", [])
], GetAppTemplateList);
exports.GetAppTemplateList = GetAppTemplateList;
