...
exports.UpdateTemplateDetail = void 0;
...
let UpdateTemplateDetail = class UpdateTemplateDetail extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
    ...
    async index(ctx, params) {
        ...
        if (!(0, tools_1.checkName)(params.name)) {
            return Response.warning(app_config_1.i18n.template.invalidTemplateName, 2071701);
        }
        try {
            ctx.logAttr = Object.assign(ctx.logAttr, { type: constant_1.TYPE.TEMPLATE });
            const hasAuth = await this.service.auth.file(params.id, { ctx });
            if (!hasAuth) {
                return Response.accessDeny(app_config_1.i18n.system.accessDeny, 4071701);
            }
            ...
            if (result.code === 1) {
                return Response.warning(app_config_1.i18n.template.invalidTemplateId, 2071702);
            }
            if (result.code === 2) {
                return Response.warning(app_config_1.i18n.template.templateNameExist, 2071703);
            }
            ...
            return Response.error(err, app_config_1.i18n.template.updateTemplateFailed, 3071701);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.updateTemplateDetail,
        description: '',
        tags: ['Template'],
...
], UpdateTemplateDetail.prototype, "index", null);
UpdateTemplateDetail = __decorate([
    (0, routing_controllers_1.JsonController)('templates'),
    __metadata("design:paramtypes", [])
], UpdateTemplateDetail);
exports.UpdateTemplateDetail = UpdateTemplateDetail;
