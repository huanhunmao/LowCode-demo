...
export declare type FoxpageComponentType<P = Record<string, unknown>> = (React.FunctionComponent<P> & FoxpageComponentStatic & FoxpageComponentLifecycle<P>) | (React.ComponentClass<P> & FoxpageComponentStatic & FoxpageComponentLifecycle<P>);
