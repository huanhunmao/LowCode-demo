...
exports.SetConditionFileStatus = void 0;
...
let SetConditionFileStatus = class SetConditionFileStatus extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
    ...
    async index(ctx, params) {
        ...
        try {
            ...
            if (!hasAuth) {
                return Response.accessDeny(app_config_1.i18n.system.accessDeny, 4100801);
            }
            ...
            if (result.code === 1) {
                return Response.warning(app_config_1.i18n.file.invalidFileId, 2100801);
            }
            else if (result.code === 2) {
                return Response.warning(app_config_1.i18n.condition.fileCannotBeDeleted, 2100802);
            }
            ...
            return Response.error(err, app_config_1.i18n.condition.setConditionStatusFailed, 3100801);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.setConditionFileStatus,
        description: '',
        tags: ['Condition'],
...
], SetConditionFileStatus.prototype, "index", null);
SetConditionFileStatus = __decorate([
    (0, routing_controllers_1.JsonController)('conditions'),
    __metadata("design:paramtypes", [])
], SetConditionFileStatus);
exports.SetConditionFileStatus = SetConditionFileStatus;
