...
exports.UpdateMockFileDetail = void 0;
...
let UpdateMockFileDetail = class UpdateMockFileDetail extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
    ...
    async index(ctx, params) {
        ...
        if (!(0, tools_1.checkName)(params.name)) {
            return Response.warning(app_config_1.i18n.mock.invalidMockName, 2191301);
        }
        try {
            ctx.logAttr = Object.assign(ctx.logAttr, { type: constant_1.TYPE.MOCK });
            const hasAuth = await this.service.auth.file(params.id, { ctx });
            if (!hasAuth) {
                return Response.accessDeny(app_config_1.i18n.system.accessDeny, 4191301);
            }
            ...
            if (result.code === 1) {
                return Response.warning(app_config_1.i18n.mock.invalidMockId, 2191302);
            }
            if (result.code === 2) {
                return Response.warning(app_config_1.i18n.mock.mockNameExist, 2191303);
            }
            ...
            return Response.error(err, app_config_1.i18n.mock.updateMockFailed, 3191301);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.updateMockFileDetail,
        description: '',
        tags: ['Mock'],
...
], UpdateMockFileDetail.prototype, "index", null);
UpdateMockFileDetail = __decorate([
    (0, routing_controllers_1.JsonController)('mocks'),
    __metadata("design:paramtypes", [])
], UpdateMockFileDetail);
exports.UpdateMockFileDetail = UpdateMockFileDetail;
