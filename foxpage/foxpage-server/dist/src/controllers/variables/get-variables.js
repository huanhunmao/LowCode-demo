...
exports.GetVariableList = void 0;
...
let GetVariableList = class GetVariableList extends base_controller_1.BaseController {
    constructor() {
        super();
    }
    /**
    ...
    async index(ctx, params) {
        try {
            ...
            return Response.error(err, app_config_1.i18n.variable.getAppVariableFailed, 3080601);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.getAppVariables,
        description: '',
        tags: ['Variable'],
...
], GetVariableList.prototype, "index", null);
GetVariableList = __decorate([
