...
let UpdateConditionDetail = class UpdateConditionDetail extends base_controller_1.BaseController {
    ...
    async index(ctx, params) {
        ...
        if (!(0, tools_1.checkName)(params.name)) {
            return Response.warning(app_config_1.i18n.file.invalidConditionName, 2101401);
        }
        try {
            ...
            if (!hasAuth) {
                return Response.accessDeny(app_config_1.i18n.system.accessDeny, 4101401);
            }
            ...
            if (result.code === 1) {
                return Response.warning(app_config_1.i18n.condition.invalidConditionId, 2101402);
            }
            if (result.code === 2) {
                return Response.warning(app_config_1.i18n.condition.conditionNameExist, 2101403);
            }
            ...
            return Response.error(err, app_config_1.i18n.condition.updateConditionFailed, 3101401);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.updateConditionFileDetail,
        description: '',
        tags: ['Condition'],
