...
let GetComponentVersionDetail = class GetComponentVersionDetail extends base_controller_1.BaseController {
    ...
    async index(params) {
        ...
        try {
            ...
            if (!contentDetail) {
                return Response.warning(app_config_1.i18n.component.invalidFileId, 2111001);
            }
            ...
            const componentIds = this.service.content.component.getComponentResourceIds([versionDetail === null || versionDetail === void 0 ? void 0 : versionDetail.content]);
            ...
            if ((_a = versionDetail === null || versionDetail === void 0 ? void 0 : versionDetail.content) === null || _a === void 0 ? void 0 : _a.resource) {
                versionDetail.content.resource = this.service.version.component.assignResourceToComponent(versionDetail.content.resource, resourceObject, { contentResource });
            }
            ...
            return Response.error(err, app_config_1.i18n.content.getComponentVersionDetailFailed, 3111001);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.getComponentVersionDetail,
    ...
    __metadata("design:paramtypes", [component_validate_types_1.ComponentFileVersionReq]),
