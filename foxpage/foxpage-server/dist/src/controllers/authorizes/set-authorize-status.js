    ...
    async index(ctx, params) {
        try {
            if (!params.ids || params.ids.length === 0) {
                return Response.warning(app_config_1.i18n.auth.invalidAuthIds, 2180301);
            }
            ...
            if (authTypes.length !== 1 || authTypeIds.length !== 1) {
                return Response.warning(app_config_1.i18n.auth.updateOneTypeTargetAuth, 2180302);
            }
            ...
            if (!hasAuth) {
                return Response.accessDeny(app_config_1.i18n.system.accessDeny, 4180301);
            }
            await this.service.auth.batchUpdateDetail(params.ids, { creator: ctx.userInfo.id, deleted: true });
            return Response.success(app_config_1.i18n.auth.setAuthorizeStatusSuccess, 1180301);
        }
        catch (err) {
            return Response.error(err, app_config_1.i18n.auth.setAuthorizedStatusFailed, 3180301);
        }
    }
};
__decorate([
    ...
    (0, routing_controllers_openapi_1.OpenAPI)({
        summary: app_config_1.i18n.sw.setAuthorizeStatus,
        description: '',
        tags: ['Authorize'],
    ...
    __metadata("design:paramtypes", [Object, authorize_validate_types_1.SetAuthStatusReq]),
